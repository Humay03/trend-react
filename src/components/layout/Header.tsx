...
export default function Header() {
    return (
        <header className="h-[66px] container mx-auto flex  justify-between items-center sticky">
            <div className="w-[146px]">
                <img src="https://cdn.dsmcdn.com/web/logo/ty-web.svg" alt="" className="w-full" />
            </div>
